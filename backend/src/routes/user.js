...
import { subscribeUser, getUser, updateUser, deleteUser, unsubscribeByToken, editSubscriptionByToken, getUserByToken, getUserCount, verifyEmail } from '../controllers/userController.js';
...
router.get('/verify-email', verifyEmail); // Verify email with token
